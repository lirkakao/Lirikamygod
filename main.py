...
async def deliver_content(message: Message, target_chat_id: int, override_text: str | None, reply_to: int | None = None):
    ...
    try:
        if message.photo:
            ...
            await bot.send_photo(target_chat_id, message.photo[-1].file_id, caption=caption, parse_mode=None, reply_parameters=rp)
        elif message.video:
            caption = override_text if override_text else message.caption
            await bot.send_video(target_chat_id, message.video.file_id, caption=caption, parse_mode=None, reply_parameters=rp)
        elif message.voice:
            await bot.send_voice(target_chat_id, message.voice.file_id, reply_parameters=rp)
        elif message.video_note:
            await bot.send_video_note(target_chat_id, message.video_note.file_id, reply_parameters=rp)
        elif message.document:
            caption = override_text if override_text else message.caption
            await bot.send_document(target_chat_id, message.document.file_id, caption=caption, parse_mode=None, reply_parameters=rp)
        elif message.sticker:
            await bot.send_sticker(target_chat_id, message.sticker.file_id, reply_parameters=rp)
        elif override_text:
            await bot.send_message(target_chat_id, override_text, parse_mode=None, reply_parameters=rp)
        elif message.text:
            await bot.send_message(target_chat_id, message.text, parse_mode=None, reply_parameters=rp)
        else:
